...
test("can search Google twice", async () => {
  ...
  await driver.wait(until.titleIs("chatgpt - Google Search"), 1000);
  ...
  await driver.findElement(By.name("q")).sendKeys("rubber duckies", Key.RETURN)
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("rubber duckies - Google Search"), 1000);
});
